...
static int responseCdmaInformationRecords(Parcel &p,
    ...
    // Ringer of death
    static int IS95_CONST_IR_SIGNAL_IS54B = 2;
    static int IS95_CONST_IR_ALERT_MED    = 0;
    static int IS95_CONST_IR_SIG_IS54B_L  = 1;
        ...
        switch (infoRec->name) {
            ...
            case RIL_CDMA_SIGNAL_INFO_REC:
                ...
                if (infoRec->rec.signal.isPresent &&
                    infoRec->rec.signal.signalType == IS95_CONST_IR_SIGNAL_IS54B &&
